...
<head>
    ...
    @vite(['resources/views/backend/assets/js/backend.js'])
   ...
   ">
        ...
        <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
            <ul class="space-y-1.5">
                <li>
                    <a class="flex items-center gap-x-3.5 py-2 px-2.5 bg-gray-100 text-sm text-neutral-700 rounded-lg dark:bg-neutral-700 dark:text-white dark:hover:bg-neutral-700 hover:bg-gray-100 dark:hover:text-neutral-300"
                        href="#">
                        <svg class="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24"
                        ...
                        <ul class="hs-accordion-group ps-3 pt-2" data-hs-accordion-always-open>
                            <li class="hs-accordion" id="users-accordion-sub-1">
                                ...
                                <div id="users-accordion-sub-1-child"
                                    ...
                                    <ul class="pt-2 ps-2">
                                        <li>
                                            <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-neutral-700 rounded-lg dark:bg-neutral-800 dark:text-neutral-400  dark:hover:bg-neutral-700 hover:bg-gray-100 dark:hover:text-neutral-300"
                                                href="#">
                                                Link 1
                                            </a>
                                        </li>
